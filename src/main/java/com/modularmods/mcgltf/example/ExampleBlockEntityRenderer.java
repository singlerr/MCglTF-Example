	...
	public void render(ExampleBlockEntity p_112307_, float p_112308_, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
		...
		if(level != null) {
			...
			case NORTH:
				break;
			case SOUTH:
				p_112309_.mulPose(new Quaternionf(0.0F, 1.0F, 0.0F, 0.0F));
				break;
			case WEST:
				p_112309_.mulPose(new Quaternionf(0.0F, 0.7071068F, 0.0F, 0.7071068F));
				break;
			case EAST:
				p_112309_.mulPose(new Quaternionf(0.0F, -0.7071068F, 0.0F, 0.7071068F));
				break;
		...
		RenderedGltfModel.setCurrentPose(p_112309_.last().pose());
		RenderedGltfModel.setCurrentNormal(p_112309_.last().normal());
		p_112309_.popPose();
